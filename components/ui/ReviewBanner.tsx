...
export function ReviewBanner({
  ...
  return (
    <div
      className={cn(
        "atlas-action-strip flex flex-col gap-3 rounded-xl border border-border bg-gradient-to-r from-accent-soft to-card p-3.5 sm:flex-row sm:items-center sm:justify-between",
        className
      )}
    >
