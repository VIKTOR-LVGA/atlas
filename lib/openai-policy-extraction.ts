...
const EXTRACTION_INSTRUCTIONS = [
  ...
  "- For Swiss motor personal policies: if the PDF shows 'Totale premio annuo' / 'Jahresprämie total', put that amount in premium_amount and set premium_frequency to annual. Keep installment cadence (Semestrale/Halbjährlich) in details.payment_frequency_label — do not multiply annual totals by installment frequency.",
  "- For motor policies also extract details.vehicle_make, details.vehicle_model, details.license_plate, and details.coverages[] with coverage_status included|excluded for Sí/No rows.",
