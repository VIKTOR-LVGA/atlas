...
const policySubtypeDefinitions: PolicySubtypeDefinition[] = [
  ...
  },
  {
    subtype: "pension_3a",
    policyType: "pension",
    label: "Previdenza vincolata 3a",
    keywords: ["pilastro 3a", "saule 3a", "prevoyance liee", "previdenza vincolata"],
  },
  {
    subtype: "pension_3b",
    policyType: "pension",
    label: "Previdenza libera 3b",
    keywords: ["pilastro 3b", "saule 3b", "prevoyance libre", "previdenza libera"],
  },
  {
    subtype: "building",
    policyType: "building",
    label: "Assicurazione stabili",
    keywords: ["assicurazione stabili", "edificio", "gebaudeversicherung", "assurance batiment"],
  },
  {
    subtype: "pet",
    policyType: "pet",
    label: "Assicurazione animali",
    keywords: ["assicurazione animali", "tierkrankenversicherung", "assurance animaux", "pet insurance"],
  },
  {
    subtype: "dental",
    policyType: "health",
...
export const swissPolicySubtypeLabels: Record<SwissPolicySubtype, string> = {
  ...
  accident: "Infortunio",
  life: "Vita",
  pension_3a: "Previdenza vincolata 3a",
  pension_3b: "Previdenza libera 3b",
  building: "Assicurazione stabili",
  pet: "Assicurazione animali",
  dental: "Dentale",
