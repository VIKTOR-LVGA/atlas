...
export const canonicalCoverageTaxonomy: CanonicalCoverageDefinition[] = [
  ...
  c("parking_damage", "vehicle", "Danni di parcheggio", ["money", "count"], ["danni di parcheggio"], ["park schaden", "parkschaden"], ["dommages de parcage"]),
  ...
  c("roadside_assistance", "vehicle", "Assistenza stradale", ["boolean", "money"], ["soccorso stradale", "assistenza"], ["pannenhilfe", "assistance"], ["depannage", "assistance"]),
  c("bonus_protection", "vehicle", "Protezione bonus", ["boolean"], ["protezione bonus"], ["bonusschutz"], ["protection du bonus"]),
  c("occupants_accident", "vehicle", "Infortuni occupanti", ["money"], ["infortuni occupanti", "conducente e passeggeri"], ["insassenunfall"], ["accidents occupants"]),
