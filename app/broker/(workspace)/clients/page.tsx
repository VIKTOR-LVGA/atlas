...
export const metadata = { title: "Clienti ATLAS | Broker" };
...
export default async function BrokerClientsPage() {
  ...
  return (
    <>
      <PartnerPageIntro
        area="clients"
        eyebrow="Clienti ATLAS assegnati"
        title="Clienti ATLAS"
        description="Solo clienti con una richiesta ATLAS assegnata a te. Non è il tuo CRM personale: documenti e polizze restano invisibili finché non vengono condivisi esplicitamente."
        actions={
          openCount > 0 ? (
